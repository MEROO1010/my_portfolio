...
const Form = () => {
  return (
    ...
    <button type="submit" className=" absolute left-2 px-4 py-2 mx-14 my-80 font-raleway text-2xl font-semibold text-white bg-gray-500 rounded-full">Send</button>
</div>
