...
const Square = () => {
  return (
    <div className="flex justify-center items-center h-screen relative  left-40 bottom-40">
    <div className="grid grid-cols-3 gap-20">
        ...
        <div className="relative py-4 right-40 bottom-60">
            <Image src="/assets/images/programming.png" alt="Programming" width={220} height={220} />
        </div>
