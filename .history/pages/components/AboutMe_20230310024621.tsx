  ...
  return (
    <div className="bg-[#697A98] static ">
        ...
        <div className=" text-[#FFFCF6]  ">
            <h1 className=" absolute mx-80 pt-18 bottom-0 left-24 font-raleway font-bold  text-[50px]">About me</h1>
            <br/>
            <p className='font-raleway font-italic relative mx-80  top-50 left-24   text-[50px]'>
