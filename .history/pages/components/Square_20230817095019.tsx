...
const Square = () => {
  return (
    <div>
      {/*logo design*/}
       <div className="absolute py-40 mx-40 my-18 left-8 top-4 ">
       <Image src="/assets/images/logodesign.png" alt="laptop" width={200} height={200}/>
       </div>

        {/*programming*/}
       <div className="absolute py-60 px-40 mx-80 my-18 right-80 bottom-40 ">
       <Image src="/assets/images/programming.png" alt="laptop" width={200} height={200}/>
       </div>

       {/*ui-ux design*/}  
       <div className="absolute py-60 mx-80 my-18 right-4 bottom-40 ">
