  ...
  return (
    <div className='bg-slate-700'>
       ...
       <button className='bg-[#19335A] rounded-3xl w-60 h-10  text-[20px] text-[#B8BFD6] font-raleway font-semibold shadow-xl' >About me</button>
        ...
        <div>
          <ul className=' absolute   float-right flex flex-col top-80 py-60 px-80 mx-80 left-32   space-x-8 md:flex-row '>
            <li><a><Image src="/assets/images/github.png" alt="main image" width={54} height={54}/></a></li>
            <li><a><Image src="/assets/images/instagram.png" alt="main image" width={54} height={64}/></a></li>
