...
const Form = () => {
  return (
    ...
    <button type="submit" className=" absolute right-80 px-30 py-2 mx-80 my-80 font-raleway text-2xl font-semibold text-white bg-gray-500 w-100 h-14 rounded-full">Send</button>
</div>
