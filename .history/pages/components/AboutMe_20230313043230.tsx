...
const AboutMe = () => {
  return (
    <div >
        ...
        <div className="  relative my-80 pt-80  top-80  ">
        <Image src="/assets/images/bg2.png" alt="laptop" width={1940} height={5106}/>
        </div>
       
        

        <div className=" text-[#FFFCF6]  ">
            <div className=" absolute  mx-80 my-4 py-2 bottom-60  left-24  ">
