...
const Form = () => {
  return (
    <div>
        <input type="text" className=" relative  px-80 mx-80 bottom-24 left-44 h-10 w-0 rounded-xl"/><br/>
        <input type="text" className=" relative  px-80 mx-80 bottom-8 left-44 h-20 w-0 rounded-xl"/><br/>
