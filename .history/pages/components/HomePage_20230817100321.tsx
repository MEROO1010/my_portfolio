...
const HomePage = () => {
  return (
    <div className='bg-slate-700'>
        ...
        <div className='mx-16 my-0 top-3  absolute	  '>
        <Image src="/my_logo_white.png" alt="My Logo" width={50} height={0}/>
        </div>

        <div>
          <ul className=' relative   float-right flex flex-col  px-8 mx-40 right-28   bottom-14   space-x-16 md:flex-row text-[#FFFCF6] text-[24px] font-raleway'>
            <li>Home</li>
            <li>About Me</li>
            <li>Skills</li>
            <li>My Work</li>
       ...
       <Image src="/assets/images/MainPage.png" alt="main image" width={1920} height={912}/>
        {/*add About Me button*/}
       <div className='absolute px-28 my-80 mx-60 left-80 top-2 '>
