...
const Form = () => {
  return (
    ...
    <input type="text" placeholder="Your Name" className="px-4 py-2 mx-4 my-2 rounded-full h-14 w-80 bottom-15"/><br/><br/>
    <input type="text" placeholder="Your Email" className="px-4 py-2 mx-4 my-2 rounded-full h-14 w-80"/><br/>
    <textarea placeholder="Message" className="px-4 py-2 mx-4 my-6 rounded-lg h-40 w-80"></textarea>
