...
const Form = () => {
  return (
    <div>
        <input type="text" className=" relative  px-80 mx-80 bottom-24 left-44 h-14 w-0 rounded-4xl"/><br/>
        <input type="text" className=" relative  px-80 mx-80 bottom-8 left-44 h-14 w-0 rounded-xl"/><br/>
