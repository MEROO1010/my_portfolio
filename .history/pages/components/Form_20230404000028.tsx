...
const Form = () => {
  return (
    <div>
        ...
        <input type="text" className=" absolute  px-80 mx-80 bottom-8 left-44 h-14 w-0 rounded-full"/><br/>
        <textarea  className=" relative  px-80 mx-80 top-8 left-44  text-align: left overflow-auto block p-2.5 w-5 h-96  text-sm text-gray-900 bg-gray-50  border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded-3xl ">Message</textarea>
