...
const HomePage = () => {
  return (
    <div className='bg-slate-700'>
        ...
        <Image src="/my_logo_white.png" alt="My Logo" width={50} height={0}/>
        </div>
       ...
       <button className='bg-[#19335A] rounded-3xl w-60 h-10  text-[20px] text-[#B8BFD6] font-raleway font-semibold shadow-xl' >About me</button>
        ...
        <div>
          <ul className=' absolute   float-right flex flex-col top-80 py-60 px-32 mx-80 right-40   space-x-8 md:flex-row '>
